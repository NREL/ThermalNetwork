...
class TestNetwork(BaseCase):
    def test_network_one_ghe(self):
        ...
        expected_outputs = {"8c369df2-18e9-439a-8c25-875851c5aaf0": {"num_bh": 50, "depth": 95.8}}
    ...
    def test_network_one_ghe_detailed(self):
        ...
        expected_outputs = {"8c369df2-18e9-439a-8c25-875851c5aaf0": {"num_bh": 36, "depth": 132.8}}
    ...
    def test_network_two_ghe_sequential(self):
        ...
        expected_outputs = {
            "dd69549c-ecfc-4245-96dc-5b6127f34f46": {"num_bh": 16, "depth": 132.6},
            "47fd01d3-3d72-46c0-85f2-a12854783764": {"num_bh": 13, "depth": 132.9},
        }
    ...
    def test_network_two_ghe_staggered(self):
        ...
        expected_outputs = {
            "dd69549c-ecfc-4245-96dc-5b6127f34f46": {"num_bh": 44, "depth": 104.7},
    ...
    def test_network_three_ghe_upstream(self):
        ...
        expected_outputs = {
            ...
            "8410c9a9-d52e-4c68-b7bc-4affae974481": {"num_bh": 72, "depth": 98.1},
    ...
    def test_network_three_ghe_area_proportional(self):
        ...
        expected_outputs = {
            ...
            "3eb26af6-a1f7-4daa-8372-ec016ca185a4": {"num_bh": 1131, "depth": 134.8},
        }
