...
class TestNetwork(BaseCase):
    ...
    def test_network_two_ghe_sequential(self):
        ...
        expected_outputs = {
            "dd69549c-ecfc-4245-96dc-5b6127f34f46": {"num_bh": 16, "depth": 131.9},
            "47fd01d3-3d72-46c0-85f2-a12854783764": {"num_bh": 13, "depth": 132.3},
        }
    ...
    def test_network_two_ghe_staggered(self):
        ...
        expected_outputs = {
            "dd69549c-ecfc-4245-96dc-5b6127f34f46": {"num_bh": 44, "depth": 104.3},
